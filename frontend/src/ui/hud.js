...
export function drawHud(ctx, { score, timeRemaining, isGameOver, blockerCount = 0, gameOverMessage = "", fomoState = "" }) {
  ctx.save();
  ...
  ctx.fillText(blockerText, ctx.canvas.width / 2 - 60, HUD_HEIGHT / 2);
